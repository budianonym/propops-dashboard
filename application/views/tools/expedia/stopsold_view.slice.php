	...
	<div class="col-xl-12">
		...
		<div class="widget has-shadow">
			...
			<div class="widget-body">
				<h6 align="center" class="text-muted font-italic">Please Submit NID/s Below. Submitting 50 NIDs need around 1 minute</h6>
				<!-- begin section -->
				<!--  -->
				<!-- <br>
					...
					<div class="form-group">
						...
						<div class="container-fluid table-responsive" id="export1">
							<table class="table-striped" >
								...
								$i = 1;
								foreach ($ids as $id) {;?>
								<?php $profile = http_request("https://EQC_Redawning:EWK3E7KDY4V2iR7@services.expediapartnercentral.com/properties/v1/redawning/".$id);
								...
								<tr>
									...
									<td><?php if (array_key_exists("errors",$profile)){
										...
										if ($profile['entity']['inventorySettings']['onStopSell']==false) {
												echo "Active";
										}else{
											echo "Inactive";
										}
